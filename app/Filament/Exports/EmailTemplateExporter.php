...
class EmailTemplateExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('subject')
                ->label(__('Subject'))
                ->state(function (EmailTemplate $record): string {
                    return $record->getTranslation('subject', app()->getLocale()) ?? __('No subject');
                }),
    ...
    {
        $body = __('Your email template export has completed and :count :rows exported.', [
    ...
    public function getXlsxWriterOptions(): ?Options
    {
        ...
        $options->setColumnWidth(40, 5);  // Subject column
    ...
    public function configureXlsxWriterBeforeClose(Writer $writer): Writer
    {
        ...
        $sheet->setName(__('Email Templates Export'));
